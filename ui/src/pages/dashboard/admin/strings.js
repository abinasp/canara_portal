...
import AllStringsStyle from '../styles';
...
class AllStrings extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      unModeratedStrings: [],
  ...
  componentDidMount() {
    ...
    if (config.defaultLangMap && config.defaultLangMap.length > 0) {
...
const AllStringsConatiner = connect(
  state => ({
...
export default withStyles(AllStringsStyle, { withTheme: true })(AllStringsConatiner);